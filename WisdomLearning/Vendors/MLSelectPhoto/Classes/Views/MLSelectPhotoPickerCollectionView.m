...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else
    {
        ...
        if (self.isRecoderSelectPicker)
        {
            ...
            {
                MLSelectPhotoAssets *ll = self.dataArray[indexPath.item];
                if ([asset isKindOfClass:[MLSelectPhotoAssets class]] && [asset.asset.defaultRepresentation.url isEqual:ll.asset.defaultRepresentation.url])
                {
