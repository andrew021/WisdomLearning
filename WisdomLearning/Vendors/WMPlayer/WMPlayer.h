...
//点击分享
-(void)wmplayer:(WMPlayer *)wmplayer clickShareButton:(UIButton *)shareBtn;
...
@property (nonatomic,retain) UIImageView *pptView;
...
@property (nonatomic, assign) double  tryTime;

@property (nonatomic, assign) BOOL  isTry;

@property (nonatomic, assign) double totalTime;

@property (nonatomic, assign) double lastWatchTime;

@property (nonatomic, copy) NSString *playType;

@property (nonatomic, copy) NSArray *pptImgList;

@property (nonatomic, copy) NSArray *pptVideoIndex;

@property (nonatomic, copy) NSString *curPptimageString;
