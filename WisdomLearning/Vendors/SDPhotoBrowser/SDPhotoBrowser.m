...
- (void)setupImageOfImageViewForIndex:(NSInteger)index
{
    ...
    else if([self baseImageForIndex:index]){
        imageView.image = [self baseImageForIndex:index];
    }
    else {
...
-(UIImage *)baseImageForIndex:(NSInteger)index
{
    if ([self.delegate respondsToSelector:@selector(photoBrowser:
                                                    baseImageForIndex:)]) {
        return [self.delegate photoBrowser:self baseImageForIndex:index];
    }
    return nil;
}
