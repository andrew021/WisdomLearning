...
@interface EaseConversationListViewController ()<CellLongPressDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for(int i;i<self.dataArray.count;i++){
        ...
        if([model.conversation.conversationId isEqualToString:chatId]){
...
//        cell.detailLabel.attributedText =  attributedText;
        ...
        cell.detailLabel.attributedText =  [[EaseEmotionEscape sharedInstance] attStringFromTextForChatting:[[_dataSource conversationListViewController:self latestMessageTitleForConversationModel:model] mutableCopy] textFont:cell.detailLabel.font];
