...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets, 90, CHAT_BUTTON_SIZE, 15)];
    _photoLabel.text = @"照片";
    _photoLabel.textAlignment = NSTextAlignmentCenter;
    _photoLabel.font = [UIFont systemFontOfSize:13];
    _photoLabel.textColor = kTextLightGray;
...
//    [_scrollview addSubview:_locationButton];
    ...
    _takePicLabel = [[UILabel alloc]initWithFrame:CGRectMake(insets*2+CHAT_BUTTON_SIZE, 90, CHAT_BUTTON_SIZE, 15)];
    _takePicLabel.text = @"相机";
    _takePicLabel.textAlignment = NSTextAlignmentCenter;
    _takePicLabel.font = [UIFont systemFontOfSize:13];
    _takePicLabel.textColor = kTextLightGray;
    [_scrollview addSubview:_takePicLabel];
