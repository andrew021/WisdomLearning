...
+ (void)initialize
{
    ...
    EaseRecordView *recordView = [self appearance];
      ...
      recordView.voiceMessageAnimationImages = @[@"record_01",@"record_02",@"record_03",@"record_04",@"record_05",@"record_06",@"record_07",@"record_08",@"record_09",@"record_10",@"record_11",@"record_12",@"record_13",@"record_14"];
...
//    return self;
    ...
    self = [super initWithFrame:CGRectMake(60, 200, SCREEN_WIDTH-120, 140)];
    if (self) {
      
        _recordAnimationView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH-120, 140)];
