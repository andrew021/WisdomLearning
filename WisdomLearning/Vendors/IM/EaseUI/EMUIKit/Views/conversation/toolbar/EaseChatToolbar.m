...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"hair_voice"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"back_textField"] forState:UIControlStateSelected];
    ...
    self.recordButton.layer.cornerRadius = 4.0;
     self.recordButton.backgroundColor = kMainDarkGreen;
...
//    [self.recordButton setTitle:kTouchToFinish forState:UIControlStateHighlighted];
   ...
   // 更多
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"chat_ expansion"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"chat_ expansion"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"back_keyBoard"] forState:UIControlStateSelected];
