...
@implementation SSV2HtmlView (Ranges)
...
- (UITextRange *)textRangeOfWordAtPosition:(UITextPosition *)position
{
    ...
    characterString = [self.attributedContentView.layoutFrame.attributedStringFragment attributedSubstringFromRange:NSMakeRange(previousPosition.location, 1)];
...
- (UITextRange *)textRangeOfURLAtPosition:(UITextPosition *)position URL:(NSURL **)URL
{
    ...
    NSURL *effectiveURL = [self.attributedContentView.layoutFrame.attributedStringFragment attribute:DTLinkAttribute atIndex:index effectiveRange:&effectiveRange];
