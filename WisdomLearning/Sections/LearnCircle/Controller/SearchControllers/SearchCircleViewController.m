...
@interface SearchCircleViewController ()<UITableViewDataSource, UITableViewDelegate,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
{
...
- (void)createRefresh
{
    __weak SearchCircleViewController* weakSelf = self;
...
//    
    if(_delegate){
        [self.delegate interactData:model.name tag:3 data:model.ID];
    }
}
